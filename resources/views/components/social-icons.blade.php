...
<div {{ $attributes->class(['flex items-center']) }}>
    ...
    {{-- <a
      ...
      target="_blank"
      class="flex h-10 w-10 items-center justify-center rounded-full border border-2 border-dark dark:border-white text-dark dark:text-white hover:text-white hover:bg-primary hover:border-primary dark:hover:border-primary mr-3 sm:mr-4 lg:mr-3 xl:mr-4"
    >
      <svg
        width="8"
        height="16"
    ...
    {{-- LinkedIn --}}
    <a
      href="https://www.linkedin.com/in/roberto-manna-b10373106/"
      target="_blank"
      class="flex h-10 w-10 items-center justify-center rounded-full border border-2 border-dark dark:border-white text-dark dark:text-white hover:text-white hover:bg-primary hover:border-primary dark:hover:border-primary mr-3 sm:mr-4 lg:mr-3 xl:mr-4"
    >
      <svg
    ...
    {{-- GitHub --}}
    <a
      href="https://github.com/Rob-Dev84"
      target="_blank"
      class="flex h-10 w-10 items-center justify-center rounded-full border border-2 border-dark dark:border-white text-dark dark:text-white hover:text-white hover:bg-primary hover:border-primary dark:hover:border-primary mr-3 sm:mr-4 lg:mr-3 xl:mr-4"
    >
      <svg
