<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg md-10">
        {{-- Video Section --}}
        <section 
            x-data="{ 
                videoOpen: false,
            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-full aspect-video relative z-20">
                    ...
                    <div
                    class="bg-primary absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center bg-opacity-0 z-10"
                    >
                    {{-- Video play --}}
                    <a
                        href="javascript:void(0)"
                        @click="videoOpen = true; url = videoUrl" 
                        class="text-primary absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-white md:h-[100px] md:w-[70px] md:h-[70px]"
                    >
            ...
            <div
                ...
                class="mx-auto w-11/12 md:w-10/12 xl:w-8/12 bg-white"
            >
                <iframe
